    ...
    <div>
      ...
      <AnimatePresence>
        {modelOpen && (
          ...
          >
            <div className=" bg-[#86929e]flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
              <motion.div
                className="inline-block w-full border-2 border-gray-200 max-w-xl p-8 my-20 overflow-hidden text-left transform text-white bg-[#86929e] rounded-lg shadow-xl 2xl:max-w-2xl border-none"
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="mt-5">
                  ...
                  <div className="flex justify-end mt-6">
                    <button
                      type="submit"
                     className="px-3 py-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-[#001F3F] rounded-md hover:bg-[#1e4974] focus:outline-none focus:bg-[#14375a] focus:ring focus:ring-indigo-300 focus:ring-opacity-50"
                    >
                      Add Member
                    </button>
                  </div>
