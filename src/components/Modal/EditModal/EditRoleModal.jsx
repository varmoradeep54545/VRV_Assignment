      ...
      {isOpen && (
        ...
        >
          <div className="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
            <motion.div
              className="inline-block w-full max-w-xl p-8 my-20 overflow-hidden text-left transform bg-[#86929e] text-white rounded-lg shadow-xl 2xl:max-w-2xl"
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="mt-5">
                ...
                <div className="mt-4">
                  <label
                    htmlFor="description"
                    className="block text-sm text-white capitalize"
                  >
                    Description
                  </label>
                  <textarea
