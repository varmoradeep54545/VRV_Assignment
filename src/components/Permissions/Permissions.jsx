...
const Permissions = () => {
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8">
      <Navbar />
      <ToastContainer />
      <div className="bg-[#6d757d] rounded-lg shadow-md mt-6 p-6 sm:p-8">
        <div className="container mx-auto">
          <div className="mb-4 flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-4 sm:space-y-0">
            <div className="flex flex-col sm:flex-row sm:space-x-4 w-full sm:w-auto items-start sm:items-center">
              <div className="relative w-full sm:w-56">
                <input
                  type="text"
                  className="p-2 pl-10 border rounded-lg focus:outline-none focus:ring-2  transition duration-300 ease-in-out w-full"
              ...
              <div className="relative w-full sm:w-56 md:mt-0 mt-3">
                <select
                  className="p-2 pl-3 border rounded-lg focus:outline-none focus:ring-2 focus:text-gray-600 transition duration-300 ease-in-out w-full"
            ...
            <div className="flex justify-center items-center gap-3">
              ...
              <button
                className="flex items-center gap-2 bg-red-600 text-white px-2 py-1 rounded-lg hover:bg-red-500 transition-colors duration-300"
          ...
          <div className="overflow-x-auto shadow bg-slate-200  rounded-lg border border-gray-100">
                ...
                <button
                  ...
                  className={`px-3 py-1 rounded-lg ${
                    i + 1 === currentPage
                      ...
                      : "bg-slate-200 text-black"
                  } hover:bg-slate-300 hover:text-black  transition-colors duration-300`}
