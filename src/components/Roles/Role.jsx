    ...
    <div className="p-4 sm:p-6 md:p-8">
      ...
      <div className="bg-[#6d757d] rounded-lg shadow-md mt-6 p-6 sm:p-8">
        <div className="container mx-auto">
          <div className="mb-4 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <div className="flex flex-col sm:flex-row sm:space-x-4 w-full sm:w-auto items-start sm:items-center">
              <div className="relative w-full sm:w-56">
                <input
                  type="text"
                  className="p-2 pl-10 border rounded-lg w-full focus:outline-none focus:ring-2 "
          ...
          {/* Table */}
          <div className="overflow-x-auto bg-slate-200 shadow border border-gray-100 rounded-lg">
