...
const User = () => {
  ...
  const paginatedUsers = filteredByRoleAndStatus.slice(
    (currentPage - 1) * rowsPerPage,
    currentPage * rowsPerPage
  );
  const totalPages = Math.ceil(filteredByRoleAndStatus.length / rowsPerPage);
    ...
    <div className="p-4 sm:p-6 md:p-8">
      ...
      <div className="bg-[#6d757d]  rounded-lg shadow-md mt-6 p-6 sm:p-8">
        <div className="container mx-auto">
          ...
          <div className="overflow-x-auto bg-slate-200 bold shadow rounded-lg border border-gray-100">
